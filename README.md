...
In this exercise, we will refactor starter code. The goal is to make the resulting website as accessible as possible. 
...
![Alt text](Develop/assets/images/01-html-css-git-homework-demo.png?raw=true "Optional Title")
